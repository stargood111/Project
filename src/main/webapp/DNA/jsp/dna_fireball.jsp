...
<body >
    ...
    <form class="form-horizontal" id="">
      <div id = "unisearch">
		...
		<button type="button" id = "unibuttion2"onclick="javascript:location.href='/Fireball?temp=${param.temp}&bar=${param.bar}&user_input=${param.user_input}'">Fireball</button>
    ...
    <div id="submitvalue" >
        <div>
            ...
            <input type="text" class="searchbox" value="저장탱크 부피(㎥)" readonly />
        ...
        <div>
            ...
            <input type="text" class="searchbox" value="저장탱크 높이(m)" readonly />
            <input type="text" class="valuebox" value=""/>
        </div>
        <div>
            <input type="text" class="searchbox" value="압력 (bar)" readonly />
            <input type="text" class="valuebox" value="" style="display: none;">
            <input type="text" class="valuebox" value="${param.bar}"/>
            <input type="text" class="valuebox" value="" style="display: none;">       
         </div>
        <!-- <div>
            <input type="text" class="valuebox" value="" style="visibility:hidden;">       
            <input type="text" class="valuebox" value="" style="visibility:hidden;">       
            <input type="text" class="valuebox" value="" style="visibility:hidden;">       
            <input type="text" class="valuebox" value="" style="visibility:hidden;">       
        </div>
