...
<body >
    ...
    <!-- 서브내브 끝 -->
     ...
     <form class="form-horizontal" id="">
      <div id = "unisearch">
		...
		<button type="button" id = "unibuttion2"onclick="javascript:location.href='/VCE?temp=${param.temp}&bar=${param.bar}&user_input=${param.user_input}'">Vapor Cloud Explosion</button>
    ...
    <div id="submitvalue" >
        <div>
            ...
            <input type="text" class="searchbox" value="폭발에 연관된 증기운 비율 (%)" readonly />
            <input type="text" class="valuebox" value=""/>
        </div>
        <div>
            <input type="text" class="searchbox" value="누출량(kg)" readonly />
            <input type="text" class="valuebox" value=""/>
